...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'Tweet Intent';
$config['webmaster_email'] = 'support@';
$config['admin_email'] = 'hello@';
...
$config['recaptcha_public_key'] = '6LdMVScTAAAAACyhxd-D62oIU5xd5jC6vBxbsMdb';
$config['recaptcha_private_key'] = '6LdMVScTAAAAAKAsA8lGbk9JwWV-bODV0WimDTWT';
