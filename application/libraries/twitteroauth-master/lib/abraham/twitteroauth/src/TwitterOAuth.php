...
class TwitterOAuth extends Config
{
     ...
     * @return array|object
     */
    public function uploadMediaNotChunked($path, $parameters)
    {
    ...
    private function request($url, $method, $authorization, $postfields)
    {
        ...
        $options = [
            ...
            CURLOPT_CONNECTTIMEOUT => "50000",//$this->connectionTimeout,
            CURLOPT_HEADER => true,
            CURLOPT_HTTPHEADER => ['Accept: application/json', $authorization, 'Expect:'],
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_SSL_VERIFYHOST => 2,
            CURLOPT_SSL_VERIFYPEER => true,
            CURLOPT_TIMEOUT => "50000",//$this->timeout,
            CURLOPT_URL => $url,
     ...
     * @throws TwitterOAuthException
     */
    private function request_token($method="POST")
    {

        $url = 'https://api.twitter.com/oauth2/token';
        $this->gzipEncoding = true;
        $bearer_token_creds = base64_encode($this->consumer->key.':'.$this->consumer->secret);
        ...
        $options = [
            ...
            CURLOPT_CONNECTTIMEOUT => "50000",//$this->connectionTimeout,
            CURLOPT_HEADER => true,
            CURLOPT_HTTPHEADER => ['Authorization: Basic '.$bearer_token_creds."\r\n".
